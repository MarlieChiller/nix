...

{
  ...
  nix.settings.allowed-users = [ "marliechiller" ];
  ...
  # upgrade NixOS to the latest version in the current channel. (To see when the service 
  # runs, see systemctl list-timers.) If allowReboot is true, then the system will automatically 
  # reboot if the new generation contains a different kernel, initrd or kernel modules.
